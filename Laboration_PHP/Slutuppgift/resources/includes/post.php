...
if ($pdo) {
    ...
    //$sql väljer ett id och namn som kommer att användas
    ...
    // kollar vad som är skrivet
    if (isset($_POST['submit'])) {
        $user = $_POST['author']; //kollar vem som skriver och sätter in det i inlägget som auther
        $headline = $_POST['title']; //kollar vad som skrevs i headline och sätter in det i inlägget som title
        $headline = trim($headline);

        $slug = slugify($headline);

        $text = $_POST['message']; //Ändrar om vad som är skrivet i $text och sätter in det i message
